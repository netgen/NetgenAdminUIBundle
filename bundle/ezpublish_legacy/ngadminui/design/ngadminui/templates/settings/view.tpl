...
<form method="post" action={"settings/view"|ezurl}>
    ...
    <div class="box-content panel">
        <div class="context-attributes">
            ...
            <div class="object">
                ...
                <div class="block">
                    ...
                    <select class="form-control" name="selectedINIFile">
                    ...
                    <select class="form-control" name="CurrentSiteAccess">
        ...
        <div class="controlbar">
            ...
            <div class="block">
                <input class="btn btn-default" type="submit" name="ChangeINIFile" value="{'Select'|i18n('design/admin/settings')}" />
            </div>
