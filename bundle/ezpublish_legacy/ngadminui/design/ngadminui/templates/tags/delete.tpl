...
<div class="context-block tags-delete">
        ...
        <div class="box-content panel">
            <form name="tagdeleteform" id="tagdeleteform" enctype="multipart/form-data" method="post" action={concat( 'tags/delete/', $tag.id )|ezurl}>
                ...
                <div class="controlbar">
                    <div class="btn-group">
                        <input class="btn btn-primary" type="submit" name="YesButton" value="{'Yes'|i18n( 'extension/eztags/tags/edit' )}" />
                        <input class="btn btn-default" type="submit" name="NoButton" value="{'No'|i18n( 'extension/eztags/tags/edit' )}" />
                    </div>
                </div>
            </form>
        </div>
    {else}
        <div class="controlbar">
            <div class="block">
                <input class="btn btn-default" type="button" onclick="javascript:history.back();" value="{'Go back'|i18n( 'extension/eztags/errors' )}" />
            </div>
        </div>
    {/if}
</div>
