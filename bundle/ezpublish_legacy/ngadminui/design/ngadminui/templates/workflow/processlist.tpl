...
<div class="box-content panel">
    ...
    <div class="context-toolbar">
        <div class="button-left">
            ...
            {case match=25}
                <a class="btn btn-default btn-sm" href={'/user/preferences/set/admin_workflow_processlist_limit/1'|ezurl} title="{'Show 10 items per page.'|i18n( 'design/admin/node/view/full' )}">10</a>
                <span class="btn btn-default btn-sm active">25</span>
                <a class="btn btn-default btn-sm" href={'/user/preferences/set/admin_workflow_processlist_limit/3'|ezurl} title="{'Show 50 items per page.'|i18n( 'design/admin/node/view/full' )}">50</a>

                {/case}

                {case match=50}
                <a class="btn btn-default btn-sm" href={'/user/preferences/set/admin_workflow_processlist_limit/1'|ezurl} title="{'Show 10 items per page.'|i18n( 'design/admin/node/view/full' )}">10</a>
                <a class="btn btn-default btn-sm" href={'/user/preferences/set/admin_workflow_processlist_limit/2'|ezurl} title="{'Show 25 items per page.'|i18n( 'design/admin/node/view/full' )}">25</a>
