<div class="panel">
    ...
    {if or( $can_edit_node, $has_manage_locations )}
        ...
        <input class="btn btn-default btn-sm" type="submit" name="RemoveAssignmentButton" value="{'Remove selected'|i18n( 'design/admin/node/view/full' )}" title="{'Remove selected locations from the list above.'|i18n( 'design/admin/node/view/full' )}" />
        {else}
        <input class="btn btn-default btn-sm" type="submit" name="RemoveAssignmentButton" value="{'Remove selected'|i18n( 'design/admin/node/view/full' )}" title="{'There is no removable location.'|i18n( 'design/admin/node/view/full' )}" disabled="disabled" />
        {/if}
        ...
        <input class="btn btn-default btn-sm" type="submit" name="AddAssignmentButton" value="{'Add locations'|i18n( 'design/admin/node/view/full' )}" title="{'Add one or more new locations.'|i18n( 'design/admin/node/view/full' )}" />
        {else}
        <input class="btn btn-default btn-sm" type="submit" name="AddAssignmentButton" value="{'Add locations'|i18n( 'design/admin/node/view/full' )}" title="{'It is not possible to add locations to a top level node.'|i18n( 'design/admin/node/view/full' )}" disabled="disabled" />
        {/if}

    {else}
        <input class="btn btn-default btn-sm" type="submit" name="RemoveAssignmentButton" value="{'Remove selected'|i18n( 'design/admin/node/view/full' )}" disabled="disabled" title="{'You cannot remove any locations because you do not have permission to edit the current item.'|i18n( 'design/admin/node/view/full' )}" />
        <input class="btn btn-default btn-sm" type="submit" name="AddAssignmentButton" value="{'Add locations'|i18n( 'design/admin/node/view/full' )}" disabled="disabled" title="{'You cannot add new locations because you do not have permission to edit the current item.'|i18n( 'design/admin/node/view/full' )}" />
    {/if}
    </div>
    ...
    {if $assignment_count|gt( 1 )}
        <input id="tab-locations-list-set-main" class="btn btn-default btn-sm" type="submit" name="UpdateMainAssignmentButton" value="{'Set main'|i18n( 'design/admin/node/view/full' )}" title="{'Select the desired main location using the radio buttons above then click this button to store the setting.'|i18n( 'design/admin/node/view/full' )}" />
        ...
        (function( $ )
        {
            $('#tab-locations-list input.main-locations-radio').change(function()
            {
                if ( this.className === 'main-locations-radio' )
                    ...
                    $('#tab-locations-list-set-main').removeClass('btn-primary').addClass('btn-default');
            });
        })( jQuery );
        {/literal}
        </script>
    {else}
        <input class="btn btn-default btn-sm" type="submit" name="UpdateMainAssignmentButton" value="{'Set main'|i18n( 'design/admin/node/view/full' )}" disabled="disabled" title="{'You cannot set the main location because there is only one location present.'|i18n( 'design/admin/node/view/full' )}" />
    {/if}

    {else}
        <input class="btn btn-default btn-sm" type="submit" name="UpdateMainAssignmentButton" value="{'Set main'|i18n( 'design/admin/node/view/full' )}" disabled="disabled" title="{'You cannot set the main location because you do not have permission to edit the current item.'|i18n( 'design/admin/node/view/full' )}" />
    {/if}
    </div>
