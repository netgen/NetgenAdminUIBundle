    ...
    <div class="box-content panel">
        ...
        <div class="context-attributes">
            ...
            <div class="block">
                ...
                <input class="form-control" id="pdfTitle" type="text" name="Title" value="{$pdf_export.title|wash}" />
            </div>
            ...
            <div class="block">
                ...
                <textarea class="form-control" name="IntroText" cols="64" rows="3">{$pdf_export.intro_text|wash}</textarea>
            </div>

            {* Sub text. *}
            <div class="block">
                <label>{'Sub text'|i18n( 'design/admin/pdf/edit' )}:</label>
                <textarea class="form-control" name="SubText" cols="64" rows="3">{$pdf_export.sub_text|wash}</textarea>
            </div>
            </fieldset>
            ...
            <div class="block">
                ...
                {/section}
                <input class="btn btn-default btn-sm" type="submit" name="ExportPDFBrowse" value="{'Browse'|i18n( 'design/admin/pdf/edit' )}" />
            ...
            <div class="block form-inline">
                <div class="form-group">
                    ...
                    <select class="form-control form-control-multiple" name="ClassList[]" multiple="multiple" size="8">
            ...
            <div class="block form-inline">
                <div class="form-group">
                    ...
                    <select class="form-control" name="DestinationType">
            ...
            <div class="block">
                ...
                <input class="form-control" type="text" name="DestinationFile" value="{$pdf_export.pdf_filename|wash}" />
            </div>
        ...
        {* DESIGN: Control bar START *}
            <input class="btn btn-primary" type="submit" name="ExportPDFButton" value="{'OK'|i18n( 'design/admin/pdf/edit' )}" />
            <input class="btn btn-default" type="submit" name="DiscardButton" value="{'Cancel'|i18n( 'design/admin/pdf/edit' )}" />
        </div>
