        ...
        <div class="box-content panel">
            <div class="row">
                <div class="col-md-6">
                    <div class="block">
                        ...
                        <input id="ezcontent_advancesearch_search_text" class="form-control" type="text" size="40" name="SearchText" value="{$full_search_text|wash}" />
                    </div>

                    <div class="block">
                        <label for="ezcontent_advancesearch_phrasesearch_text">{'Search for an exact phrase'|i18n( 'design/admin/content/search' )}:</label>
                        <input id="ezcontent_advancesearch_phrasesearch_text" class="form-control" type="text" size="40" name="PhraseSearchText" value="{$phrase_search_text|wash}" />
                    </div>
                </div>
            </div>
            <div class="block clearfix">
                <div class="element">
                    ...
                    <select class="form-control" id="ezcontent_advancesearch_class_id" name="SearchContentClassID">
                        <option value="-1">{'Any class'|i18n( 'design/admin/content/search' )}</option>
                        {section name=ContentClass loop=$content_class_array }
                            <option 
                            {switch name=sw match=$search_contentclass_id}
                                {case match=$ContentClass:item.id}
                                    selected="selected"
                                {/case}
                                {case}
                                {/case}
                            {/switch} value="{$ContentClass:item.id}">{$ContentClass:item.name|wash}
                            </option>
                        {/section}
                    </select>
                </div>
                ...
                <div class="element">
                    ...
                    <div class="form-inline">
                        {section name=Attribute show=$search_contentclass_id|gt( 0 )}
                            ...
                            <select class="form-control" id="ezcontent_advancesearch_class_attribute_id" name="SearchContentClassAttributeID">
            ...
            <div class="block clearfix">
                <div class="element">
                    ...
                    <select class="form-control" id="ezcontent_advancesearch_section_id" name="SearchSectionID">
                        <option value="-1">{'Any section'|i18n( 'design/admin/content/search' )}</option>
                        {section name=Section loop=$section_array }
                            <option 
                            {switch name=sw match=$search_section_id}
                ...
                <div class="element">
                    ...
                    <select class="form-control" id="ezcontent_advancesearch_date" name="SearchDate">
                ...
                {if $use_template_search}
                    <div class="element">
                        ...
                        <select class="form-control" id="ezcontent_advancesearch_pagelimit" name="SearchPageLimit">
