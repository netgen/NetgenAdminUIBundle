...
<tr>
    ...
    {if eq( $select_type, 'checkbox' )}
        <i class="fa fa-check-square-o" title="{'Invert selection.'|i18n( 'design/admin/content/browse' )}" onclick="ezjs_toggleCheckboxes( document.browse, '{$select_name}[]' ); return false;"></i>
    {else}
        &nbsp;
    {/if}
    </th>
