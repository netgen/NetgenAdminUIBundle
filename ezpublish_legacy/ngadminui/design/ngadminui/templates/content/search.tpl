            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group">
                        <input class="form-control" type="text" name="SearchText" id="Search" value="{$search_text|wash}" />
                    <span class="input-group-btn">
                        <input class="btn btn-default"  name="SearchButton" type="submit" value="{'Search'|i18n( 'design/admin/content/search' )}" />
                    </span>
                    </div>
                </div>
            </div>
