...
{/if}
<select class="form-control input-sm"{eq( $ui_context, 'edit' )|choose( '', ' disabled="disabled"' )} name="CacheTypeValue">
...
<div class="block">
    <input class="btn btn-primary btn-sm"{eq( $ui_context, 'edit' )|choose( '', ' disabled="disabled"' )} type="submit" name="ClearCacheButton" value="{'Clear'|i18n( 'design/standard/pagelayout' )}" />
</div>
{/default}
</form>
{/let}
