...
<form name="clearcacheform" method="post" action={"/setup/cache/"|ezurl}>
    ...
    <div class="panel">
        ...
        <h2>{'Clear caches'|i18n( 'design/admin/setup/cache' )}</h2>
    ...
    <div class="panel">
        ...
        <h2>{'Fine-grained cache control'|i18n( 'design/admin/setup/cache' )}</h2>
        ...
        <table class="list" cellspacing="0">
            <tr>
                <th class="tight"><i class="fa fa-check-square-o" onclick="ezjs_toggleCheckboxes( document.clearcacheform, 'CacheList[]' ); return false;" title="{'Invert selection.'|i18n( 'design/admin/setup/cache' )}"></i></th>
        ...
        <div class="controlbar">
            ...
            <div class="block">
                <input class="button" type="submit" name="ClearCacheButton" value="{'Clear selected'|i18n( 'design/admin/setup/cache' )}" context-title="{'Clear the selected caches.'|i18n( 'design/admin/setup/cache' )}" />
            </div>
