...
<div class="checkbox">
    <label><input type="checkbox" name="ContentClass_ezisbn_13_value_{$class_attribute.id}" {if $content.ISBN13}checked="checked"{/if}/>
    <strong>{'ISBN-13 format'|i18n( 'design/standard/class/datatype' )}</strong></label>
