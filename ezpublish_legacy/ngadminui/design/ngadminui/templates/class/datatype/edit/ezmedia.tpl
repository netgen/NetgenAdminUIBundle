...
<select name="ContentClass_ezmedia_type_{$class_attribute.id}" class="form-control">
...
<input type="text" class="form-control" name="ContentClass_ezmedia_max_filesize_{$class_attribute.id}" value="{$class_attribute.data_int1}" size="5" maxlength="5" />&nbsp;MB
</div>
