...
<tr class="{$Objects.sequence}">
    ...
    <td><a href={concat( 'content/edit/', $Objects.item.contentobject_id )|ezurl}><i class="fa fa-pencil-square-o" title="{'Edit <%object_name>.'|i18n( 'design/admin/url/view',, hash( '%object_name', $Objects.item.name ) )|wash}"></i></a></td>
</tr>
{/if}
