		...
		<div class="box-content panel">
			...
			<fieldset>
				...
				<div class="block clearfix">
					...
					{section-exclude match=$Limitations:item.name|eq('Node')}
						...
						<select class="form-control form-control-multiple" id="ezrole_createpolizy_limitation_{$Limitations:item.name|wash}" name="{$Limitations:item.name|wash}[]" size="8" {if or( not( is_set( $Limitations:item.single_select ) ), not($Limitations:item.single_select) ) }multiple="multiple"{/if} >
			...
			<div class="controlbar">
				...
				<div class="block">
					...
					<input class="btn btn-primary" type="submit" name="AddLimitation" value="{'OK'|i18n( 'design/admin/role/createpolicystep3' )}" />
					<input class="btn btn-default" type="submit" name="Cancel" value="{'Cancel'|i18n( 'design/admin/role/createpolicystep3' )}" />
				</div>
