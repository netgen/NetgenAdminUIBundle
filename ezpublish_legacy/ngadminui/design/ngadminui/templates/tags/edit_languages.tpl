    ...
    <div class="box-content panel">
        <form method="post" action={concat( 'tags/edit/', $tag.id )|ezurl}>
            ...
            <div class="controlbar">
                <div class="btn-group">
                    <input class="btn btn-primary" type="submit" name="EditButton" value="{'Edit'|i18n( 'extension/eztags/tags/edit' )}" />
                    <input class="btn btn-default" type="submit" name="DiscardButton" value="{'Cancel'|i18n( 'extension/eztags/tags/edit' )}" />
                </div>
            </div>
        </form>
    </div>
