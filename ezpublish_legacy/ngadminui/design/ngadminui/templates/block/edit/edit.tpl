...
<div class="block-header float-break">
    ...
    <div class="button-right">
        <span class="block-control-icon block-control-up"><input id="block-up-{$block_id}" type="button" name="CustomActionButton[{$attribute.id}_move_block_up-{$zone_id}-{$block_id}]" alt="{'Move up'|i18n( 'design/standard/block/edit' )}" title="{'Move up'|i18n( 'design/standard/block/edit' )}" /></span><span class="block-control-icon block-control-down"><input id="block-down-{$block_id}" type="button" name="CustomActionButton[{$attribute.id}_move_block_down-{$zone_id}-{$block_id}]" alt="{'Move down'|i18n( 'design/standard/block/edit' )}" title="{'Move down'|i18n( 'design/standard/block/edit' )}" /></span><span class="block-control-icon block-control-remove"><input id="block-remove-{$block_id}" type="button" name="CustomActionButton[{$attribute.id}_remove_block-{$zone_id}-{$block_id}]" title="{'Remove'|i18n( 'design/standard/block/edit' )}" alt="{'Remove'|i18n( 'design/standard/block/edit' )}" onclick="return confirmDiscard( '{'Are you sure you want to remove this block?'|i18n( 'design/standard/block/edit' )}' );" /></span>
    </div>
</div>
